  ...
  <div id="sobre" class="pb-10">
    ...
    <div>
      ...
      <ul class="flex flex-wrap gap-3 w-full">
        <li
          class="bg-zinc-500 bg-opacity-10 text-zinc-300 py-1 px-3 rounded-md"
...
#buttons a {
  @apply flex bg-zinc-500  bg-opacity-10 items-center gap-2 font-semibold text-gray-300  py-2 px-4 rounded-lg transition duration-300 hover:bg-zinc-300 hover:bg-opacity-10  focus:outline-none focus:ring-2 focus:ring-cyan-300;
}
#buttons a svg {
  @apply text-xl;
}
